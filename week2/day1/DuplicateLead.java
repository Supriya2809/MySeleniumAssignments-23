...
public class DuplicateLead {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//to find the element Create Lead using linktext and do click action
		 ...
		 //to find the element Duplicate Lead and do click action
		 driver.findElement(By.linkText("Duplicate Lead")).click();
		 
		 Thread.sleep(2000);
		 //to find the element for company name, clear it and add new name
		 driver.findElement(By.id("createLeadForm_companyName")).clear();
		 driver.findElement(By.id("createLeadForm_companyName")).sendKeys("NewTestLeaf");
		 
		 Thread.sleep(2000);
		//to find the element for first name, clear it and add new name
